    ...
    public static void main(String[] args) {
       ...
       while (true){
        ...
        for (int i = 0; i < age.size(); i++) {
            System.out.println(fname.get(id.get(i)) + " " + sname.get(id.get(i)).toUpperCase().charAt(0)+"."+lname.get(id.get(i)).toUpperCase().charAt(0)+". " + age.get(id.get(i)) + " " + gender.get(id.get(i)));
        }
    }
}